...
<div class="card" style="padding: 50px; width: 40%; margin: 0 auto; margin-top: 10%; background: #66667C;" >
<h3 style="text-align: center;" class="orange-text">Login</h3>
	<form method="POST">
		<div class="input_field;">
			<label for="username"; style="color: #ffffff">Username</label>
			<input id="username" type="text" name="username" required style="color: #ffffff">
		</div>
		<div class="input_field" >
			<label for="password"; style="color: #ffffff">Passowrd</label>
			<input id="password" type="password" name="password" required style="color: #ffffff">
		</div>
