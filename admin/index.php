  ...
  <html>
    ...
    <div class="row" >
      <div class="col s12 m3">
          <ul id="slide-out" class="sidenav sidenav-fixed"; style="background: #66667C">
              <li>
                  <div class="user-view">
              ...
              <li><a href="index.php?p=dashboard"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">dashboard</i>Dashboard</a></li>
              <li><a href="index.php?p=registrasi"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">featured_play_list</i>Registrasi</a></li>
              <li><a href="index.php?p=pengaduan"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">report</i>Pengaduan</a></li>
              <li><a href="index.php?p=respon"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">question_answer</i>Respon</a></li>
              <li><a href="index.php?p=user"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">account_box</i>User</a></li>
              <li><a href="index.php?p=laporan"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">book</i>Laporan</a></li>

              <li>
                  <div class="divider"></div>
              </li>
              <li><a class="waves-effect" href="../index.php?p=logout"; style="color: #ffffff"><i class="material-icons"; style="color: #ffffff">logout</i>Logout</a></li>
          </ul>
